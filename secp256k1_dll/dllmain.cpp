...
ALWAYS_INLINE
inline static void sub(uint64_t x, uint64_t& y, uint64_t& of1, uint64_t& of2, uint64_t& of3) {
	__asm(R"(
		subq %[x], %[y]
		sbbq $0, %[of1]
		sbbq $0, %[of2]
...
ALWAYS_INLINE
inline static void add_u448_384(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t x5, uint64_t x6, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5, uint64_t& y6, uint64_t& y7) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void add_u448_256(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5, uint64_t& y6, uint64_t& y7) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void add_u384_256(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5, uint64_t& y6) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void add_u384_320(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t x5, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5, uint64_t& y6) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void add_u320_192(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void add_u320_128(uint64_t x1, uint64_t x2, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq $0, %[y3]
...
ALWAYS_INLINE
inline static void add_u256_192(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void sub_u256_192(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4) {
	__asm(R"(
		subq %[x1], %[y1]
		sbbq %[x2], %[y2]
		sbbq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void add_u320_256(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5) {
	__asm(R"(
		addq %[x1], %[y1]
		adcq %[x2], %[y2]
		adcq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void sub_u320_u256(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4, uint64_t& y5) {
	__asm(R"(
		subq %[x1], %[y1]
		sbbq %[x2], %[y2]
		sbbq %[x3], %[y3]
...
ALWAYS_INLINE
inline static void sub_u256_u256(uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t& y1, uint64_t& y2, uint64_t& y3, uint64_t& y4) {
	__asm(R"(
		subq %[x1], %[y1]
		sbbq %[x2], %[y2]
		sbbq %[x3], %[y3]
...
inline uint32_t lzcnt(uint64_t x) {
	uint64_t r;
	__asm(R"(
		lzcntq %[x], %[r]
	)" : [r] "=a"(r) : [x] "r"(x));
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline int u256_less_than(const uint64_t a[4], const uint64_t b[4]) {
	uint8_t ret;
	__asm(R"(
		subq %[b0], %[a0]
		sbbq %[b1], %[a1]
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline int u256_less_than_equal(const uint64_t a[4], const uint64_t b[4]) {
	uint8_t ret;
	__asm(R"(
		subq %[b0], %[a0]
		sbbq %[b1], %[a1]
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline int u256_great_than(const uint64_t a[4], const uint64_t b[4]) {
	return u256_less_than(b, a);
}

extern "C" __declspec(dllexport) ALWAYS_INLINE
inline int u256_great_than_equal(const uint64_t a[4], const uint64_t b[4]) {
	return u256_less_than_equal(b, a);
}


ALWAYS_INLINE
inline static void u320_mod_p_sub(uint64_t& x1, uint64_t& x2, uint64_t& x3, uint64_t& x4, uint64_t x5) {
	constexpr uint64_t negP = 0x1000003d1; // 2^256 - p
	uint64_t t0 = x1, t1 = x2, t2 = x3, t3 = x4;
...
ALWAYS_INLINE
inline static void u320_mod_p_add(uint64_t& x1, uint64_t& x2, uint64_t& x3, uint64_t& x4, uint64_t x5) {
	constexpr uint64_t negP = 0x1000003d1; // 2^256 - p
	if (x5 == 0) {
...
*/
	...
	mul(x7, negP, x7, H2);
	mul(x8, negP, x8, H3);
	add_u256_192(H0, H1, H2, x6, x7, x8, H3); // 用 [x5,x6,x7,x8,H3] 存 uint320
...
inline void u256_mul_u64_p(const uint64_t a[4], uint64_t b, uint64_t r[4]) {
...
extern "C" __declspec(dllexport)
void u256_mul_p(const uint64_t a[4], const uint64_t b[4], uint64_t r[4]) {
	/*
														 3             2             1             0
														 3             2             1             0
------------------------------------------------------------------------------------------------------
...
extern "C" __declspec(dllexport)
void u256_square_p(const uint64_t a[4], uint64_t r[4]) {
	/*
														 3             2             1             0
														 3             2             1             0
------------------------------------------------------------------------------------------------------
...
H33           L33           L23           L13           L03           L02           L01           L00
	...
	*/
	...
	uint64_t t0, t1, t2, t3, t4, t5, t6, t7;
	uint64_t L00, L01, L02, L03, L11, L12, L13, L22, L23, L33;
	uint64_t H00, H01, H02, H03, H11, H12, H13, H22, H23, H33;
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline void u256_norm_p(uint64_t x[4]) {
	u320_mod_p_sub(x[0], x[1], x[2], x[3], 0);
}

extern "C" __declspec(dllexport) ALWAYS_INLINE
inline void u256_add_p(const uint64_t a[4], const uint64_t b[4], uint64_t r[4]) {
	uint64_t t0 = a[0], t1 = a[1], t2 = a[2], t3 = a[3], t4 = 0;
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline void u256_sub_p(const uint64_t a[4], const uint64_t b[4], uint64_t r[4]) {
	uint64_t t0 = a[0], t1 = a[1], t2 = a[2], t3 = a[3], t4 = 1;
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline void u256_neg_p(const uint64_t a[4], uint64_t r[4]) {
	if (a[0] || a[1] || a[2] || a[3]) {
		uint64_t t0 = 0xfffffffefffffc2fULL, t1 = ~0ULL, t2 = ~0ULL, t3 = ~0ULL;
...
ALWAYS_INLINE
inline void u256_pow_part_p(uint64_t ret[4], uint64_t temp[4], uint64_t pow) {
...
ALWAYS_INLINE
inline void u256_pow_part_p(uint64_t ret[4], uint64_t temp[4], uint64_t pow, uint32_t bits) {
...
extern "C" __declspec(dllexport)
void u256_pow_u64_p(const uint64_t a[4], uint64_t b, uint64_t r[4]) {
	uint64_t ret[] = { 1, 0, 0, 0 }, temp[] = { a[0], a[1], a[2], a[3] };
	if (b) {
...
extern "C" __declspec(dllexport)
void u256_pow_p(const uint64_t a[4], const uint64_t b[4], uint64_t r[4]) {
	uint64_t ret[] = { 1, 0, 0, 0 }, temp[] = { a[0], a[1], a[2], a[3] };
	if (b[3]) {
...
extern "C" __declspec(dllexport)
void u256_inv_p(const uint64_t a[4], uint64_t r[4]) {
	...
	uint64_t ret[] = { a[0], a[1], a[2], a[3] }, temp[] = { a[0], a[1], a[2], a[3] };
	u256_square_p(temp, temp);
...
extern "C" __declspec(dllexport)
int u256_sqrt_p(const uint64_t a[4], uint64_t r[4]) {
	uint64_t cond[] = { a[0], a[1], a[2], a[3] }, t[] = { a[0], a[1], a[2], a[3] };
	u256_square_p(t, t); u256_mul_p(cond, t, cond);
	u256_square_p(t, t); u256_mul_p(cond, t, cond);
	uint64_t ret[] = { t[0], t[1], t[2], t[3] };
	...
	u256_square_p(t, t); u256_mul_p(cond, t, cond);
	if (cond[0] == 1 && !cond[1] && !cond[2] && !cond[3]) {
		r[0] = ret[0];
		r[1] = ret[1];
		r[2] = ret[2];
		r[3] = ret[3];
...
ALWAYS_INLINE
inline static void u320_mod_n_sub(uint64_t& x1, uint64_t& x2, uint64_t& x3, uint64_t& x4, uint64_t x5) {
	constexpr uint64_t N0 = 0xbfd25e8cd0364141ULL, N1 = 0xbaaedce6af48a03bULL, N2 = 0xfffffffffffffffeULL;
	constexpr uint64_t negN0 = 0x402da1732fc9bebfULL, negN1 = 0x4551231950b75fc4ULL, negN2 = 1ULL;
...
ALWAYS_INLINE
inline static void u320_mod_n_add(uint64_t& x1, uint64_t& x2, uint64_t& x3, uint64_t& x4, uint64_t x5) {
	constexpr uint64_t N0 = 0xbfd25e8cd0364141ULL, N1 = 0xbaaedce6af48a03bULL, N2 = 0xfffffffffffffffeULL;
	constexpr uint64_t negN0 = 0x402da1732fc9bebfULL, negN1 = 0x4551231950b75fc4ULL, negN2 = 1ULL;
...
ALWAYS_INLINE
inline static void u256_mod_n(uint64_t& x1, uint64_t& x2, uint64_t& x3, uint64_t& x4) {
	u320_mod_n_sub(x1, x2, x3, x4, 0);
}

static void u512_mod_n(uint64_t& x1, uint64_t& x2, uint64_t& x3, uint64_t& x4, uint64_t x5, uint64_t x6, uint64_t x7, uint64_t x8) {
	constexpr uint64_t N0 = 0xbfd25e8cd0364141ULL, N1 = 0xbaaedce6af48a03bULL, N2 = 0xfffffffffffffffeULL;
	constexpr uint64_t negN0 = 0x402da1732fc9bebfULL, negN1 = 0x4551231950b75fc4ULL, negN2 = 1ULL;
	constexpr uint64_t negN0_2 = 0x805b42e65f937d7eULL, negN1_2 = 0x8aa24632a16ebf88ULL, negN2_2 = 2ULL; // -N*2
  ...
  H             3            L13           L03           L02           L01           L00
			   H13            2            L12           L11           L10
							 ...
							 H12           H02           H01
										   H11           H10
	*/
	uint64_t L00, L01, L02, L03, L10, L11, L12, L13;
	uint64_t H00, H01, H02, H03, H10, H11, H12, H13;
	...
	uint64_t t0 = L00, t1 = L01, t2 = L02, t3 = L03, t4 = L13, t5 = x8, t6 = 0;
...
extern "C" __declspec(dllexport)
void u256_mul_n(const uint64_t a[4], const uint64_t b[4], uint64_t r[4]) {
	/*
														 3             2             1             0
														 3             2             1             0
------------------------------------------------------------------------------------------------------
...
extern "C" __declspec(dllexport)
void u256_square_n(const uint64_t a[4], uint64_t r[4]) {
	/*
														 3             2             1             0
														 3             2             1             0
------------------------------------------------------------------------------------------------------
...
extern "C" __declspec(dllexport)
void u256_inv_n(const uint64_t a[4], uint64_t r[4]) {
	if (a[0] == 1 && a[1] == 0 && a[2] == 0 && a[3] == 0) {
		r[0] = 1;
		r[1] = 0;
		r[2] = 0;
...
extern "C" __declspec(dllexport)
void u256_norm_n(uint64_t a[4]) {
	u256_mod_n(a[0], a[1], a[2], a[3]);
}

extern "C" __declspec(dllexport) ALWAYS_INLINE
inline void u256_add_n(const uint64_t a[4], const uint64_t b[4], uint64_t r[4]) {
	uint64_t t0 = a[0], t1 = a[1], t2 = a[2], t3 = a[3], t4 = 0;
	add_u320_256(b[0], b[1], b[2], b[3], t0, t1, t2, t3, t4);
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline void u256_sub_n(const uint64_t a[4], const uint64_t b[4], uint64_t r[4]) {
	uint64_t t0 = a[0], t1 = a[1], t2 = a[2], t3 = a[3], t4 = 1;
	sub_u320_u256(b[0], b[1], b[2], b[3], t0, t1, t2, t3, t4);
...
extern "C" __declspec(dllexport) ALWAYS_INLINE
inline void u256_neg_n(const uint64_t a[4], uint64_t r[4]) {
	if (a[0] || a[1] || a[2] || a[3]) {
		uint64_t t0 = 0xbfd25e8cd0364141ULL, t1 = 0xbaaedce6af48a03bULL, t2 = ~1ULL, t3 = ~0ULL;
		sub_u256_u256(a[0], a[1], a[2], a[3], t0, t1, t2, t3);
		r[0] = t0;
		r[1] = t1;
		r[2] = t2;
